...
public class WallFollowingLab {
  ...
  private static final int motorLow = 300; // Speed of slower rotating wheel (deg/sec)
  private static final int motorHigh = 600; // Speed of the faster rotating wheel (deg/seec)
